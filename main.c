...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2015/02/05 14:53:15 by ebreda            #+#    #+#             */
/*   Updated: 2015/02/12 19:49:22 by ebreda           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
printf("\n*************** FT_CAT ***************\n");
   ...
   char    str8[14] = "Bonjour monde";
   printf("str1: %s\nstr2: %s\nret1 = %i\n",str7, str8, ft_strcmp(str7, str8));
   printf("str1: Bonjour monde\nstr2: %s\nres: %i\n", str8, ft_strcmp("bonjour monde", str8));
   return (0);
}
